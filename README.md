...
This is great to complete your *SpeedRunStarknet*.
...
- 📃ETHERSCAN_API_KEY variable in packages/snfoundry/.env with your generated API key. You can get your key [here](https://etherscan.io/myapikey).
